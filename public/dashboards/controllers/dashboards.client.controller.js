...
$scope.dataset = [];
   ...
   $scope.predictionGraphPerMonthDevices();                
    ...
    $scope.peak_usage_cost_per_unit = 2.0;
    $scope.off_peak_usage_cost_per_unit = 1.50;        
...
$scope.categoriesPredictionCostOfYear2014 = [
    {
     ...
     {
        "seriesname": "2014 Prediction Bill",
        "data": [
